...
`;
  ...
  // src/ExampleButton.js
  var import_react, import_prop_types, import_react_ui_components, import_neos_ui_decorators, import_neos_ui_ckeditor5_bindings, ExampleButton;
  var init_ExampleButton = __esm({
    "src/ExampleButton.js"() {
      ...
      ExampleButton = class extends import_react.PureComponent {
        constructor() {
          super(...arguments);
          this.handleClick = () => {
            (0, import_neos_ui_ckeditor5_bindings.executeCommand)("highlightCommand");
          };
        }
        render() {
          const props = {
  ...
  var addExamplePlugin;
  var init_manifest2 = __esm({
    "src/manifest.js"() {
      init_dist();
      init_examplePlugin();
      init_ExampleButton();
      addExamplePlugin = (ckEditorConfiguration, options) => {
      ...
      dist_default("Neos.Neos.Ui.ExtensibilityExamples:CustomStylingForCkEditor", {}, (globalRegistry) => {
