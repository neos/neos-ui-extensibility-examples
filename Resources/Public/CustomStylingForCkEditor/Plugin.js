...
var _examplePlugin = __webpack_require__(20);

var _examplePlugin2 = _interopRequireDefault(_examplePlugin);

var _ExampleButton = __webpack_require__(56);
...
(0, _neosUiExtensibility2.default)('Neos.Neos.Ui.ExtensibilityExamples:CustomStylingForCkEditor', {}, function (globalRegistry) {
    ...
    config.set('exampleExtension', addPlugin(_examplePlugin2.default));
});
...
var _attributecommand = __webpack_require__(54);
...
var Example = function (_Plugin) {
    ...
    _createClass(Example, [{
        ...
        value: function init() {
            ...
            this.editor.commands.add('exampleCommand', new _attributecommand2.default(this.editor, 'exampleAttribute')); // "exampleCommand" is the identifier of the command now
        }
    }], [{
        key: 'pluginName',
        get: function get() {
...
var _command = __webpack_require__(55);
...
var _reactUiComponents = __webpack_require__(59);

var _neosUiDecorators = __webpack_require__(60);

var _neosUiCkeditor5Bindings = __webpack_require__(61);

var _reactRedux = __webpack_require__(62);

var _neosUiReduxStore = __webpack_require__(63);
...
var SpellCheckButton = (_dec = (0, _reactRedux.connect)((0, _plowJs.$transform)({
    ...
    _inherits(SpellCheckButton, _PureComponent);
    ...
    function SpellCheckButton() {
        ...
        _classCallCheck(this, SpellCheckButton);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SpellCheckButton.__proto__ || Object.getPrototypeOf(SpellCheckButton)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function () {
            (0, _neosUiCkeditor5Bindings.executeCommand)('exampleCommand');
        }, _temp), _possibleConstructorReturn(_this, _ret);
    }

    _createClass(SpellCheckButton, [{
        key: 'render',
...
exports.default = SpellCheckButton;
