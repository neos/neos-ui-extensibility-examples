...
(0, _neosUiExtensibility2.default)('Neos.Neos.Ui.ExtensibilityExamples:ReplacingComponentsViaUnplannedExtensibility', {}, function (globalRegistry) {
    ...
    containerRegistry.add('LeftSideBar', (0, _AdjustedSidebar2.default)(OriginalLeftSideBar));
});
...
var contextTheme = {
    '@neos-project/react-ui-components/button': __webpack_require__(10)
};

var makeAdjustedSidebar = function makeAdjustedSidebar(OriginalLeftSideBar) {
    return function (_PureComponent) {
        _inherits(CustomSidebar, _PureComponent);

        function CustomSidebar() {
            _classCallCheck(this, CustomSidebar);

            return _possibleConstructorReturn(this, (CustomSidebar.__proto__ || Object.getPrototypeOf(CustomSidebar)).apply(this, arguments));
        }

        _createClass(CustomSidebar, [{
            key: 'render',
            value: function render() {
                ...
                return _react2.default.createElement(
                    ...
                    { theme: contextTheme },
                    _react2.default.createElement(OriginalLeftSideBar, props)
                );
            }
        }]);
