...
}), _dec(_class = _dec2(_class = (_temp2 = _class2 = class ModifyDataButton extends _react.PureComponent {
    constructor() {
        var _temp;

        return _temp = super(...arguments), this.handleClick = function () {
...
var _modifyDataPlugin = __webpack_require__(/*! ./modifyDataPlugin */ "./src/modifyDataPlugin.js");

var _modifyDataPlugin2 = _interopRequireDefault(_modifyDataPlugin);

var _ModifyDataButton = __webpack_require__(/*! ./ModifyDataButton */ "./src/ModifyDataButton.js");
...
(0, _neosUiExtensibility2.default)('Neos.Neos.Ui.ExtensibilityExamples:ModifyDataWithCommandCKEditor', {}, function (globalRegistry) {
    ...
    richtextToolbar.set('modifyDataPlugin', {
        ...
        isVisible: (0, _plowJs.$get)(['formatting', 'Neos.Neos.Ui.ExtensibilityExamples:modifyDataCommand']),
...
var ModifyDataCommand = class ModifyDataCommand extends _ckeditor5Exports.Command {
    execute(callback) {
        var data = this.editor.getData();
        this.editor.setData(data.toUpperCase());
    }
};
var ModifyData = class ModifyData extends _ckeditor5Exports.Plugin {
