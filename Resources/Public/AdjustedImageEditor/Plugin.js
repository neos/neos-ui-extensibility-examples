...
function makeCustomImageEditor(DefaultImageEditor) {
    ...
    return _temp2 = _class = class MyImageEditor extends _react.PureComponent {
        constructor() {
            var _temp, _this;
        ...
        value: _propTypes2.default.oneOfType([_propTypes2.default.shape({ __identifier: _propTypes2.default.string }), _propTypes2.default.string]),
...
var _ImageEditor = __webpack_require__(/*! ./ImageEditor */ "./src/ImageEditor.js");
